...
void initializeDefaultScene (out STriangle triangles[24], out SSphere spheres[2])
{
	...
	triangles[4].v2 = vec3(5.0, 5.0, -8.0); 
	...
	triangles[12].v1 = vec3(3.5, -4.0, 0.0);
	triangles[12].v2 = vec3(1.5, -4.0, 0.0);
	triangles[12].v3 = vec3(1.5, -4.0, -2.0); 
	triangles[12].MaterialIdx = 7;
	
	triangles[13].v1 = vec3(3.5,-4.0, -2.0);
	triangles[13].v2 = vec3(3.5, -4.0, 0.0);
	triangles[13].v3 = vec3(1.5, -4.0, -2.0); 
	triangles[13].MaterialIdx = 7;

	triangles[14].v1 = vec3(1.5, -4.0, 0.0);
	triangles[14].v2 = vec3(1.5, -4.0, -2.0);
	triangles[14].v3 = vec3(1.5, -2.0, -0.0); 
	triangles[14].MaterialIdx = 7;

	triangles[15].v1 = vec3(1.5, -2.0, -2.0);
	triangles[15].v2 = vec3(1.5, -2.0, 0.0);
	triangles[15].v3 = vec3(1.5, -4.0, -2.0); 
	triangles[15].MaterialIdx = 7;

	triangles[16].v1 = vec3(1.5, -4.0, 0.0);
	triangles[16].v2 = vec3(1.5, -2.0, 0.0);
	triangles[16].v3 = vec3(3.5, -4.0, 0.0); 
	triangles[16].MaterialIdx = 7;

	triangles[17].v1 = vec3(1.5, -2.0, 0.0);
	triangles[17].v2 = vec3(3.5, -2.0, 0.0);
	triangles[17].v3 = vec3(3.5, -4.0, 0.0); 
	triangles[17].MaterialIdx = 7;

	triangles[18].v1 = vec3(3.5, -4.0, -2.0);
	triangles[18].v2 = vec3(3.5, -4.0, 0.0);
	triangles[18].v3 = vec3(3.5, -2.0, -0.0); 
	triangles[18].MaterialIdx = 7;

	triangles[19].v1 = vec3(3.5, -2.0, 0.0);
	triangles[19].v2 = vec3(3.5, -2.0, -2.0);
	triangles[19].v3 = vec3(3.5, -4.0, -2.0); 
	triangles[19].MaterialIdx = 7;

	triangles[20].v1 = vec3(3.5, -2.0, 0.0);
	triangles[20].v2 = vec3(1.5, -2.0, 0.0);
	triangles[20].v3 = vec3(1.5, -2.0, -2.0); 
	triangles[20].MaterialIdx = 7;
	
	triangles[21].v1 = vec3(3.5,-2.0, -2.0);
	triangles[21].v2 = vec3(3.5, -2.0, 0.0);
	triangles[21].v3 = vec3(1.5, -2.0, -2.0); 
	triangles[21].MaterialIdx = 7;

	triangles[16].v1 = vec3(3.5, -4.0, -2.0);
	triangles[16].v2 = vec3(1.5, -2.0, -2.0);
	triangles[16].v3 = vec3(1.5, -4.0, -2.0); 
	triangles[16].MaterialIdx = 7;

	triangles[17].v1 = vec3(3.5, -2.0, -2.0);
	triangles[17].v2 = vec3(1.5, -2.0, -2.0);
	triangles[17].v3 = vec3(3.5, -4.0, -2.0); 
	triangles[17].MaterialIdx = 7;
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[8]) 
{
	...
	materials[7].Color = vec3(0.3, 0.8, 0.4);  
